...
interface BulkBlockStudentModalProps {
    studentCount: number;
    currentUser: AdminInfo;
    onClose: () => void;
    onBlock: (durationMs: number | 'PERMANENT') => void;
}
...
export const BulkBlockStudentModal: React.FC<BulkBlockStudentModalProps> = ({ studentCount, currentUser, onClose, onBlock }) => {
        ...
        >
            ...
            >
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-white">Block Multiple Students</h2>
                    <p className="text-gray-400 mt-1">
                        Apply blocking options to <span className="font-semibold text-indigo-300">{studentCount} selected students</span>.
                    </p>
                </div>
